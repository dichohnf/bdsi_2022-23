	...
	\part{Progettazione Logica}
		...
		\section{Traduzione verso il modello relazionale}
			...
			\begin{minipage}[t]{8.5cm}
				\fbox{\includegraphics[width=4.5cm, height=4.5cm]{./include/bdsi-prog-2023-Schema.1.pdf}}
			\end{minipage}
			...
			\vspace{.3cm}
			\centering	
			\fbox{\includegraphics[width=9cm, height=3.5cm]{./include/bdsi-prog-2023-Schema.2.pdf}}\\\vspace{.2cm}
			Fase(\underline{codice}, torneo, nome, modalita, scontri)\\
			...
			\begin{minipage}[t]{6cm}
				\fbox{\includegraphics[width=4.5cm, height=3cm]{./include/bdsi-prog-2023-Schema.3.pdf}}
			\end{minipage}
			\begin{minipage}[b]{11cm}
				\begin{flushright}
					Insieme\_squadre(\underline{codice}, fase, nome)\\
					Squadra(\underline{codice}, nome, tipologia, composizione, colori, campo)\\
					Raggruppamento(\underline{insieme\_squadre}, \underline{squadra})\\
			...
			\vspace{.3cm}
			\begin{minipage}[t]{6cm}
				\fbox{\includegraphics[width=4.5cm, height=4.5cm]{./include/bdsi-prog-2023-Schema.4.pdf}}
			\end{minipage}
			\begin{minipage}[b]{11cm}
				\begin{flushright}
					Giornata(\underline{codice}, fase, numero)\\
			...
			\vspace{.3cm}
			\fbox{\includegraphics[ height=3cm]{./include/bdsi-prog-2023-Schema.5.pdf}}\\\vspace{.2cm}
			Squadra(\underline{codice}, nome, tipologia, composizione, colori, campo)\\
			...
			\begin{minipage}[b]{6cm}
				\fbox{\includegraphics[width=6.5cm, height=4cm]{./include/bdsi-prog-2023-Schema.6.pdf}}
			\end{minipage}
			...
			\vspace{.3cm}
			\begin{minipage}[b]{6cm}
				\fbox{\includegraphics[width=4cm, height=3.5cm]{./include/bdsi-prog-2023-Schema.7.pdf}}
			\end{minipage}
			\begin{minipage}[b]{10cm}
				\begin{flushright}
					Partita(\underline{codice}, giornata, giorno, ora, squadra\_casa, squadra\_ospite, arbitro, campo, gol\_casa, gol\_ospite)\\
					Arbitro(\underline{tessera}, nome, cognome, data, genere)\\
					Partita.arbitro → Arbitro.tessera
					\vspace{1cm}
				\end{flushright}
			\end{minipage}
			...
			\begin{minipage}[b]{5cm}
				\fbox{\includegraphics[width=5cm, height=3.5cm]{./include/bdsi-prog-2023-Schema.8.pdf}}
			\end{minipage}
			\hspace{1mm}
			\begin{minipage}[b]{11cm}
				\begin{flushright}
					Squadra(\underline{codice}, nome, tipologia, composizione, colori, campo)\\
					Giocatore(\underline{tessera}, nome, cognome, data,\\ genere, squadra, numero)\\
					Giocatore.squadra → Squadra.codice
					\vspace{1cm}
				\end{flushright}
			\end{minipage}
			
			\vspace{.3cm}
			\fbox{\includegraphics[ height=3.5cm]{./include/bdsi-prog-2023-Schema.9.pdf}}\\\vspace{.2cm}
